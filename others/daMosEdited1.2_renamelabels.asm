...
.exportzp dp_mos_vdu_status		:= $d0
.exportzp dp_mos_vdu_grpixmask	:= $d1
.exportzp dp_mos_vdu_txtcolourOR		:= $d2
.exportzp dp_mos_vdu_txtcolourEOR	:= $d3
.exportzp dp_mos_vdu_gracolourOR		:= $d4
.exportzp dp_mos_vdu_gracolourEOR	:= $d5
.exportzp dp_mos_vdu_gra_char_cell		:= $d6
.exportzp dp_mos_vdu_gra_char_cell+1		:= $d7
.exportzp dp_mos_vdu_top_scanline		:= $d8
.exportzp dp_mos_vdu_top_scanline+1	:= $d9
.exportzp dp_mos_vdu_wksp		:= $da
.exportzp dp_mos_vdu_wksp+1		:= $db
.exportzp dp_mos_vdu_wksp+2		:= $dc
.exportzp dp_mos_vdu_wksp+3		:= $dd
.exportzp dp_mos_vdu_wksp+4		:= $de
.exportzp dp_mos_vdu_wksp+5		:= $df
.exportzp dp_mos_vdu_mul		:= $e0
.exportzp dp_mos_vdu_mul+1	:= $e1
.exportzp dp_mos_cfs_w		:= $e2
.exportzp dp_mos_opt_val		:= $e3
.exportzp dp_mos_GSREAD_quoteflag		:= $e4
.exportzp dp_mos_GSREAD_characc		:= $e5
.exportzp dp_mos_OS_wksp		:= $e6
.exportzp dp_mos_autorep_countdown	:= $e7
.exportzp dp_mos_input_buf		:= $e8
.exportzp dp_mos_input_buf+1		:= $e9
.exportzp dp_mos_rs423timeout		:= $ea
.exportzp dp_mos_cfs_critical		:= $eb
.exportzp dp_mos_keynumlast		:= $ec
.exportzp dp_mos_keynumfirst		:= $ed

.exportzp dp_mos_OSBW_A			:= $ef
.exportzp dp_mos_OSBW_X			:= $f0
.exportzp dp_mos_OSBW_Y			:= $f1
.exportzp dp_mos_txtptr		:= $f2
.exportzp dp_mos_txtptr+1		:= $f3
.exportzp dp_mos_curROM		:= $f4
...
; OSBYTE variables
.export sysvar_OSVARADDR		:= $0236
.export sysvar_ROMPTRTAB		:= $0238
.export sysvar_ROMINFOTAB		:= $023a
.export sysvar_KEYB_ADDRTRANS		:= $023c
.export sysvar_ADDRVDUVARS		:= $023e

.export sysvar_CFSTOCTR		:= $0240
.export sysvar_CURINSTREAM		:= $0241
.export sysvar_KEYB_SEMAPHORE		:= $0242
.export sysvar_PRI_OSHWM		:= $0243
.export sysvar_CUR_OSHWM   	:= $0244
.export sysvar_RS423_MODE		:= $0245
.export sysvar_EXPLODESTATUS		:= $0246
.export sysvar_CFSRFS_SWITCH		:= $0247
.export sysvar_VIDPROC_CTL_COPY		:= $0248
.export sysvar_VIDPROC_PAL_COPY		:= $0249
.export sysvar_ROMNO_ATBREAK		:= $024a
.export sysvar_ROMNO_BASIC		:= $024b
.export sysvar_ADC_CUR		:= $024c
.export sysvar_ADC_MAX		:= $024d
.export sysvar_ADC_ACCURACY		:= $024e
.export sysvar_RS423_USEFLAG		:= $024f
.export sysvar_RS423_CTL_COPY		:= $0250
.export sysvar_FLASH_CTDOWN		:= $0251
.export sysvar_FLASH_SPACE_PERIOD		:= $0252
.export sysvar_FLASH_MARK_PERIOD		:= $0253
.export sysvar_KEYB_AUTOREP_DELAY		:= $0254
.export sysvar_KEYB_AUTOREP_PERIOD		:= $0255
.export sysvar_EXEC_FILE		:= $0256
.export sysvar_SPOOL_FILE		:= $0257
.export sysvar_BREAK_EFFECT		:= $0258
.export sysvar_KEYB_DISABLE		:= $0259
.export sysvar_KEYB_STATUS		:= $025a
.export sysvar_RS423_BUF_EXT		:= $025b
.export sysvar_RS423_SUPPRESS		:= $025c
.export sysvar_RS423CASS_SELECT		:= $025d
.export sysvar_ECO_OSBW_INTERCEPT		:= $025e
.export sysvar_ECO_OSRDCH_INTERCEPT		:= $025f
.export sysvar_ECO_OSWRCH_INTERCEPT		:= $0260
.export sysvar_SPEECH_SUPPRESS		:= $0261
.export sysvar_SOUND_SUPPRESS		:= $0262
.export sysvar_BELL_CH		:= $0263
.export sysvar_BELL_ENV		:= $0264
.export sysvar_BELL_FREQ		:= $0265
.export sysvar_BELL_DUR		:= $0266
.export sysvar_STARTUP_DISPOPT		:= $0267
.export sysvar_KEYB_SOFTKEY_LENGTH		:= $0268
.export sysvar_SCREENLINES_SINCE_PAGE		:= $0269
.export sysvar_VDU_Q_LEN		:= $026a
.export sysvar_KEYB_TAB_CHAR			:= $026b
.export sysvar_KEYB_ESC_CHAR		:= $026c
.export sysvar_KEYB_C0CF_INSERT_INT		:= $026d
.export sysvar_KEYB_D0DF_INSERT_INT		:= $026e
.export sysvar_KEYB_E0EF_INSERT_INT		:= $026f
.export sysvar_KEYB_F0FF_INSERT_INT		:= $0270
.export sysvar_KEYB_808F_INSERT_INT		:= $0271
.export sysvar_KEYB_909F_INSERT_INT		:= $0272
.export sysvar_KEYB_A0AF_INSERT_INT		:= $0273
.export sysvar_KEYB_B0BF_INSERT_INT		:= $0274
.export sysvar_KEYB_ESC_ACTION		:= $0275
.export sysvar_KEYB_ESC_EFFECT		:= $0276
.export sysvar_USERVIA_IRQ_MASK_CPY		:= $0277
.export sysvar_ACIA_IRQ_MASK_CPY		:= $0278
.export sysvar_SYSVIA_IRQ_MASK_CPY		:= $0279
.export sysvar_TUBE_PRESENT		:= $027a
.export sysvar_SPEECH_PRESENT		:= $027b
.export sysvar_OUTSTREAM_DEST		:= $027c
.export sysvar_KEY_CURSORSTAT		:= $027d
.export sysvar_FX238		:= $027e
.export sysvar_FX239		:= $027f
.export sysvar_COUNTRY		:= $0280
.export sysvar_USERFLAG		:= $0281
.export sysvar_SERPROC_CTL_CPY		:= $0282
.export sysvar_TIMER_SWITCH		:= $0283
.export sysvar_KEYB_SOFT_CONSISTANCY		:= $0284
.export sysvar_PRINT_DEST		:= $0285
.export sysvar_PRINT_IGNORE		:= $0286
.export sysvar_BREAK_VECTOR_JMP		:= $0287
.export sysvar_BREAK_VECTOR_LOW		:= $0288
.export sysvar_BREAK_VECTOR_HIGH		:= $0289
.export sysvar_SHADOW1		:= $028a
.export sysvar_SHADOW2		:= $028b
.export sysvar_CUR_LANG		:= $028c
.export sysvar_BREAK_LAST_TYPE		:= $028d
.export sysvar_RAM_AVAIL		:= $028e
.export sysvar_STARTUP_OPT		:= $028f

.export oswksp_VDU_VERTADJ		:= $0290
.export oswksp_VDU_INTERLACE		:= $0291
...
.export vduvar_GRA_WINDOW_LEFT+1		:= $0301
.export vduvar_GRA_WINDOW_BOTTOM		:= $0302
.export vduvar_GRA_WINDOW_BOTTOM+1		:= $0303
.export vduvar_GRA_WINDOW_RIGHT		:= $0304
.export vduvar_GRA_WINDOW_RIGHT+1		:= $0305
.export vduvar_GRA_WINDOW_TOP		:= $0306
.export vduvar_GRA_WINDOW_TOP+1		:= $0307
.export vduvar_TXT_WINDOW_LEFT		:= $0308
.export vduvar_TXT_WINDOW_BOTTOM		:= $0309
.export vduvar_TXT_WINDOW_RIGHT		:= $030a
.export vduvar_TXT_WINDOW_TOP		:= $030b
.export vduvar_GRA_ORG_EXT		:= $030c
.export vduvar_GRA_ORG_EXT+1		:= $030d
.export vduvar_GRA_ORG_EXT+2		:= $030e
.export vduvar_GRA_ORG_EXT+3		:= $030f
.export vduvar_GRA_CUR_EXT		:= $0310
.export vduvar_GRA_CUR_EXT+1		:= $0311
.export vduvar_GRA_CUR_EXT+2		:= $0312
.export vduvar_GRA_CUR_EXT+3		:= $0313

.export vduvar_TXT_CUR_X		:= $0318
.export vduvar_TXT_CUR_Y		:= $0319
.export vduvar_GRA_CUR_CELL_LINE		:= $031a
.export vduvar_VDU_Q_START		:= $031b
.export vduvar_VDU_Q_START+1		:= $031c
.export vduvar_VDU_Q_START+2		:= $031d
.export vduvar_VDU_Q_START+3		:= $031e
.export vduvar_VDU_Q_START+4		:= $031f
.export vduvar_VDU_Q_START+5		:= $0320
.export vduvar_VDU_Q_START+6		:= $0321
.export vduvar_VDU_Q_START+7		:= $0322
.export vduvar_VDU_Q_START+8		:= $0323
.export vduvar_GRA_CUR_INT		:= $0324
.export vduvar_GRA_CUR_INT+1		:= $0325
.export vduvar_GRA_CUR_INT+2		:= $0326
.export vduvar_GRA_CUR_INT+3		:= $0327
.export vduvar_TEMP_8		:= $0328
.export vduvar_TEMP_8+1		:= $0329
.export vduvar_TEMP_8+2		:= $032a
.export vduvar_TEMP_8+3		:= $032b
.export vduvar_TEMP_8+4		:= $032c
.export vduvar_TEMP_8+5		:= $032d
.export vduvar_TEMP_8+6		:= $032e
.export vduvar_TEMP_8+7		:= $032f

.export vduvar_GRA_WKSP		:= $0330

.export vduvar_6845_CURSOR_ADDR		:= $034a
.export vduvar_6845_CURSOR_ADDR+1		:= $034b
.export vduvar_TXT_WINDOW_WIDTH_BYTES		:= $034c
.export vduvar_TXT_WINDOW_WIDTH_BYTES+1		:= $034d
.export vduvar_SCREEN_BOTTOM_HIGH		:= $034e
.export vduvar_BYTES_PER_CHAR			:= $034f

.export vduvar_6845_SCREEN_START			:= $0350
.export vduvar_6845_SCREEN_START+1		:= $0351
.export vduvar_BYTES_PER_ROW			:= $0352
.export vduvar_BYTES_PER_ROW+1		:= $0353
.export vduvar_SCREEN_SIZE_HIGH		:= $0354
.export vduvar_MODE		:= $0355
.export vduvar_MODE_SIZE		:= $0356
.export vduvar_TXT_FORE		:= $0357
.export vduvar_TXT_BACK		:= $0358
.export vduvar_GRA_FORE		:= $0359
.export vduvar_GRA_BACK		:= $035a
.export vduvar_GRA_PLOT_FORE		:= $035b
.export vduvar_GRA_PLOT_BACK		:= $035c
.export vduvar_VDU_VEC_JMP		:= $035d
.export vduvar_VDU_VEC_JMP+1		:= $035e
.export vduvar_CUR_START_PREV		:= $035f

.export vduvar_COL_COUNT_MINUS1		:= $0360
.export vduvar_PIXELS_PER_BYTE_MINUS1		:= $0361
.export vduvar_LEFTMOST_PIX_MASK		:= $0362
.export vduvar_RIGHTMOST_PIX_MASK		:= $0363
.export vduvar_TEXT_IN_CUR_X		:= $0364
.export vduvar_TEXT_IN_CUR_Y		:= $0365
.export vduvar_MO7_CUR_CHAR		:= $0366
.export vduvar_EXPLODE_FLAGS		:= $0367
.export vduvar_FONT_LOC32_63		:= $0368
.export vduvar_FONT_LOC64_95		:= $0369
.export vduvar_FONT_LOC96_127		:= $036a
.export vduvar_FONT_LOC128_159		:= $036b
.export vduvar_FONT_LOC160_191		:= $036c
.export vduvar_FONT_LOC192_223		:= $036d
.export vduvar_FONT_LOC224_255		:= $036e
.export vduvar_PALLETTE		:= $036f
...
.export sheila_CRTC_reg		:= $fe00
.export sheila_CRTC_rw		:= $fe01
...
_VDUCHR:		ldx	sysvar_VDU_Q_LEN			; get number of items in VDU queue
...
_BC4EF:			tay					; Y=A
			...
			sta	sysvar_VDU_Q_LEN			; store it as number of items in VDU queue
			txa					; get back A
			lsr					; A=A/16
			lsr					; 
			lsr					; 
...
_BC545:			sta	vduvar_VDU_VEC_JMP+1			; upper byte of link address
			tya					; restore A
...
_BC985:			sty	sheila_CRTC_reg			; else set CRTC address register
			sta	sheila_CRTC_rw			; and poke new value to register Y
_BC98B:			rts					; exit
...
_BCA27:			sbc	#$74				; mode 7 subtract &74
			eor	#$20				; EOR with &20
SET_CRTC_YeqAX:		sty	sheila_CRTC_reg			; write to CRTC address file register
			sta	sheila_CRTC_rw			; and to relevant address (register 14)
			iny					; Increment Y
			sty	sheila_CRTC_reg			; write to CRTC address file register
			stx	sheila_CRTC_rw			; and to relevant address (register 15)
			rts					; and RETURN
...
_LCB33:			bit	sysvar_RAM_AVAIL			; Check available RAM
...
_BCB3A:			and	#$07				; X=A and 7 ensure legal mode
			...
			sta	vduvar_COL_COUNT_MINUS1			; Set current number of logical colours less 1
			lda	_TXT_BPC_TABLE,X		; Get bytes/character for this MODE
			sta	vduvar_BYTES_PER_CHAR				; Set bytes per character
			lda	_TBL_VDU_PIXPB,X			; Get pixels/byte for this MODE
			sta	vduvar_PIXELS_PER_BYTE_MINUS1			; Set pixels per byte
...
_BCB56:			asl					; A=A*2
			...
			sta	vduvar_RIGHTMOST_PIX_MASK			; colour mask left
_BCB5E:			asl					; A=A*2
			bpl	_BCB5E				; If still +ve CB5E
			sta	vduvar_LEFTMOST_PIX_MASK			; colour mask right
			ldy	_TAB_MAP_TYPE,X			; screen display memory index table
			sty	vduvar_MODE_SIZE			; memory map type
			...
			sta	vduvar_SCREEN_SIZE_HIGH			; screen RAM size hi byte
			lda	_VDU_MEMLOC_TAB,Y		; screen ram address hi byte
			sta	vduvar_SCREEN_BOTTOM_HIGH			; hi byte of screen RAM address
			...
			sta	dp_mos_vdu_mul			; store it
			lda	#>_MUL640_TABLE			; A=&C3
			sta	dp_mos_vdu_mul+1			; store it (&E0) now points to C3B5 or C375
...
_LCBC1_DOCLS:		ldx	#$00				; X=0
			...
			ldx	vduvar_MODE_SIZE			; memory map type
			ldy	_TAB_CLS_ENTER,X		; get section control number
			sty	vduvar_VDU_VEC_JMP			; set it in jump vector lo
			ldy	#>_VDU_CLEAR_20K		; Y=&CC
			sty	vduvar_VDU_VEC_JMP+1			; upper byte of link address
			ldx	#$00				; X=0
			...
			jmp	(vduvar_VDU_VEC_JMP)			; jump vector set up previously to clear screen memory
...
__reset_memclr_done:	stx	sysvar_RAM_AVAIL			; writes marker for available RAM 40 =16k,80=32
			stx	sysvar_KEYB_SOFT_CONSISTANCY			; write soft key consistency flag
...
__reset_keyread_loop:	txa					; A=X
			...
			ror	dp_mos_INT_A			; rotate MSB into bit 7 of &FC
			...
			bne	__reset_keyread_loop		; and if >0 do loop again
								...
								; X=0
			stx	sysvar_BREAK_LAST_TYPE			; clear last BREAK flag
			rol	dp_mos_INT_A			; CTRL is now in carry &FC is keyboard links
...
_BDA36:			inc	sysvar_BREAK_LAST_TYPE			; &28D=&28D+1
			lda	dp_mos_INT_A			; get keyboard links set
			eor	#$ff				; invert
...
_BDA5B:			lda	_VECTOR_TABLE-1,Y		; copy data from &D93F+Y
			...
			lda	#$62				; A=&62
			sta	dp_mos_keynumfirst			; store in &ED
...
__reset_vias_loop:	sta	SYS_VIA_IFR,X			; 
			...
			bit	dp_mos_INT_A			; if bit 6=1 then JSR &F055 (normally 0)
...
_BDAA2:			lda	#$27				; set T1 (hi) to &27 this sets T1 to &270E (9998 uS)
			...
			ldx	sysvar_KEYB_SOFT_CONSISTANCY			; get soft key status flag
...
;*************************************************************************
			...
			ldx	dp_mos_curROM			; get RAM copy of ROM No. in X
			ldy	dp_mos_curROM			; and Y
...
;*************************************************************************
			...
			dec	sysvar_SPEECH_PRESENT			; (027B)=&FF to indicate speech present
...
;*********** SCREEN SET UP **********************************************
				; X=0
_BDB27:			lda	sysvar_STARTUP_OPT			; get back start up options (mode)
...
;********* enter BREAK intercept with Carry Clear ************************
			...
			dec	sysvar_TUBE_PRESENT			; else set tube flag to show it's active
...
_BDB4D:			ldy	#$0e				; set current value of PAGE
			...
			and	sysvar_STARTUP_DISPOPT			; if A=&FE and bit 7 of 0267 is set then continue
			bpl	_BDB87				; else ignore start up message
			ldy	#$02				; output to screen
			jsr	_PRINT_PAGEC3_STRING		; 'BBC Computer ' message
			lda	sysvar_BREAK_LAST_TYPE			; 0=warm reset, anything else continue
			beq	_BDB82				; 
			ldy	#$16				; by checking length of RAM
			bit	sysvar_RAM_AVAIL			; 
...
_BDB87:			sec					; 
			...
			lsr					; 
			lsr					; 
			eor	sysvar_STARTUP_OPT			; eor with start-up options which may or may not
			and	#$08				; invert bit 4
			tay					; Y=A
			...
			ldx	#$d2				; 
			ldy	#$ea				; 
			dec	sysvar_STARTUP_DISPOPT			; decrement ignore start up message flag
			jsr	OSCLI				; and execute */!BOOT
			inc	sysvar_STARTUP_DISPOPT			; restore start up message flag
...
_BDBBE:			lda	sysvar_BREAK_LAST_TYPE			; get last RESET Type
			bne	_BDBC8				; if not soft reset DBC8

			ldx	sysvar_CUR_LANG			; else get current language ROM address
...
;*************** check if tube present ***********************************
			...
			bit	sysvar_TUBE_PRESENT			; and TUBE is connected else
...
_OSRDRM:		ldx	dp_mos_curROM			; get current ROM number into X
			sty	dp_mos_curROM			; store new number in &F4
			sty	ROM_LATCH			; switch in ROM
			ldy	#$00				; get current PHROM address
			lda	(dp_mos_genPTR),Y			; and get byte
...
_IRQ_HANDLER:		sta	dp_mos_INT_A			; save A
...
; ---------------------------------------------------------
_BDC68:			sec					
			ror	sysvar_RS423_USEFLAG			; Set b7 of RS423 busy flag
			bit	sysvar_RS423_CTL_COPY			; check bit 7 of current ACIA control register
...
; -------------------------------
			ldx	sysvar_RS423_SUPPRESS			; Read RS423 input suppression flag
...
_IRQ1V:			cld					; Clear decimal flag
			lda	dp_mos_INT_A			; Get original value of A
			pha					; Save it
			txa					; Save X
			pha					; 
			tya					; and Y
...
; -----------------------------------
__irq_acia:		ldx	dp_mos_rs423timeout			; Get RS423 timeout counter
			dex					; Decrement it
...
_BDCBF:			ldx	#$02				
			...
			lda	sysvar_PRINT_DEST			; Read printer destination
...
_BDCD6:			sta	ACIA_TXRX			; Send byte to ACIA
			...
			sta	dp_mos_rs423timeout			; Serial owns 6850 for 103 more calls
_BDCDD:			rts					; Exit IRQ
...
_BDCDE:			and	sysvar_ACIA_IRQ_MASK_CPY			; AND with ACIA IRQ mask (normally &FF)
...
; RxData but no RxIRQ, check that IRQs are actually disabled
			...
			ldy	sysvar_RS423_CTL_COPY			; Get ACIA control setting
...
_IRQ_UNKNOWN:		ldx	#$05				
			...
			tax					; 
			pla					; 
			sta	dp_mos_INT_A			; Store A in IRQA
...
; System VIA interupt
			...
			and	sysvar_SYSVIA_IRQ_MASK_CPY			; Mask with System VIA bit mask
...
; System VIA CA1 interupt (Frame Sync)
			...
			lda	dp_mos_rs423timeout			; A=RS423 Timeout counter
			bpl	_BDD1E				; if +ve then DD1E
			inc	dp_mos_rs423timeout			; else increment it
_BDD1E:			lda	sysvar_FLASH_CTDOWN			; load flash counter
...
_BDD8D:			jsr	_OSBYTE_145			; Fetch Speech command byte from buffer
			sta	dp_mos_curPHROM			; Store it
			jsr	_OSBYTE_145			; Fetch Speech word high byte from buffer
			sta	dp_mos_genPTR+1			; Store it
			jsr	_OSBYTE_145			; Fetch Speech word low byte from buffer
			sta	dp_mos_genPTR				; Store it, giving &F6/7=address to be accessed
			ldy	dp_mos_curPHROM			; Y=Speech command byte
			beq	_BDDBB				; SOUND &FF00 - Speak from RAM, no reset
			bpl	_BDDB8				; SOUND &FF01-&FF7F - Speak from RAM, with reset
			bit	dp_mos_curPHROM			; Check bit 6 of Speech command
...
_BDDAB:			asl	dp_mos_genPTR				; Multiply address by 2 to index into word table
			rol	dp_mos_genPTR+1			; 
...
_BDDB2:			ldy	sysvar_SPEECH_SUPPRESS			; Fetch command code, usually &50=Speak or &00=Nop
...
_IRQ2V:			lda	dp_mos_INT_A			; get back original value of A
...
_BDE95:			stx	sysvar_ADC_CUR			; store it as current ADC channel
			ldy	sysvar_ADC_ACCURACY			; get conversion type
			dey					; decrement
			tya					; A=Y
			and	#$08				; and it with 08
			clc					; clear carry
			adc	sysvar_ADC_CUR			; add to current ADC
			sbc	#$00				; -1
			sta	ADC_SR				; store to the A/D control panel
			rts					; and return

_PRINT_PAGEC3_STRING:	lda	#$c3				; point to start of string @&C300
_PRINT_PAGE_STRING:	sta	dp_mos_error_ptr+1			; store it
			lda	#$00				; point to lo byte
			sta	dp_mos_error_ptr			; store it and start loop@

_LDEB1:			iny					; print character in string
			lda	(dp_mos_error_ptr),Y			; pointed to by &FD/E
...
__cliv_not_slash:	sty	dp_mos_OS_wksp				; Store offset to start of command
			ldx	#$00				
			beq	_BDFD7				
...
__nobasic:		ldy	dp_mos_OS_wksp				; Restore pointer to start of command
...
_SKIP_SPACE:		lda	(dp_mos_txtptr),Y			
			cmp	#$20				
...
_BE0D6:			lda	sysvar_OUTSTREAM_DEST			; Check output destination
			...
			ldy	dp_mos_rs423timeout			; Get serial timout counter
...
_BE0F7:			lda	#$10				; Check output destination
			...
			ldy	sysvar_SPOOL_FILE			; Get SPOOL handle
			beq	_BE10D				; If not open, skip past SPOOL output
			pla					; Get character back
			pha					; Resave character
			sec					
			ror	dp_mos_cfs_critical			; Set RFS/CFS's 'spooling' flag
			jsr	OSBPUT				; Write character to SPOOL channel
			lsr	dp_mos_cfs_critical			; Reset RFS/CFS's 'spooling' flag
...
_PRINTER_OUT:		bit	sysvar_OUTSTREAM_DEST			; if bit 6 of VDU byte =1 printer is disabled
			bvs	__printer_out_done		; so E139

			cmp	sysvar_PRINT_IGNORE			; compare with printer ignore character
...
_PRINTER_OUT_ALWAYS:	php					; else save flags
			...
			tax					; X=A
			lda	#$04				; A=4
			bit	sysvar_OUTSTREAM_DEST			; read bit 2 'disable printer driver'
...
_LE13A:			lda	sysvar_PRINT_DEST			; check printer destination
...
_BE164:			cmp	#$02				; is it Serial printer??
			...
			ldy	dp_mos_rs423timeout			; else is RS423 in use by cassette??
			dey					; 
...
_LE1A2:			ldx	#$03				; X=3
_LE1A4:			ldy	sysvar_PRINT_DEST			; Y=printer destination
...
_LE21F:			sty	dp_mos_OS_wksp				; &E6=Y
			rol					; A=A*2
			rol					; *4
			rol					; *8
			rol					; *16
...
_BE227:			rol					; A=A*32
			...
			ldy	dp_mos_OS_wksp				; get back original Y
			rts					; and exit
...
_OSCLI_SPOOL:		php					; if A=0 file is closed so
			sty	dp_mos_OS_wksp				; Store Y
			ldy	sysvar_SPOOL_FILE			; get file handle
			sta	sysvar_SPOOL_FILE			; store A as file handle
			beq	_BE28F				; if Y<>0 then E28F
			jsr	OSFIND				; else close file via osfind
_BE28F:			ldy	dp_mos_OS_wksp				; get back original Y
			plp					; pull flags
...
_BE391:			cpx	dp_mos_OS_wksp				; if key being defined is found
...
_LE3D1:			php					; push P
			...
			txa					; save X
			pha					; push A
			ldy	dp_mos_OS_wksp				; get key number
...
_BE3F6:			dec	sysvar_KEYB_SOFT_CONSISTANCY			; decrement consistence flag to &FF to warn that key
...
_BE40D:			tya					; store end of moved string(s)
			pha					; 
			ldy	dp_mos_OS_wksp				; get back key number
...
_BE422:			dex					; point to next lowest string def
			...
			tax					; put A in X
			inc	sysvar_KEYB_SOFT_CONSISTANCY			; reset consistency flag
			plp					; restore flags
			rts					; and exit
...
_OSBYTE_137:		lda	sysvar_SERPROC_CTL_CPY			; get serial ULA control setting
			tay					; Y=A
...
_LE6A7:			sta	sysvar_SERPROC_CTL_CPY			; store serial ULA flag
...
_OSBYTE_10:		lda	sysvar_FLASH_SPACE_PERIOD,Y			; get mark period count
			pha					; push it
			txa					; get new count
			...
			stx	sysvar_FLASH_CTDOWN			; else restore old value
...
_OSBYTE_2:		txa					; A=X
			...
			pha					; push A
			lda	sysvar_RS423_CTL_COPY			; and get current ACIA control setting
			rol					; Bit 7 into carry
			cpx	#$01				; if X>=1 then
			ror					; bit 7 of A=1
			cmp	sysvar_RS423_CTL_COPY			; compare this with ACIA control setting
			php					; push processor
			sta	sysvar_RS423_CTL_COPY			; put A into ACIA control setting
...
_BE6F1:			ldx	sysvar_CURINSTREAM			; get current input buffer number
			pla					; get back A
			sta	sysvar_CURINSTREAM			; store it
			rts					; and return
...
_BE70B:			lda	sysvar_ADC_MAX			; get  current maximum ADC channel number
			stx	sysvar_ADC_MAX			; store new value
...
_LE741:			sec					
			...
			cpx	sysvar_RS423_BUF_EXT			; else compare with minimum buffer space
_BE74E:			rts					; and exit
...
_BE7A2:			lda	_OSBYTE_TABLE + 1,Y		; get address from table
			...
			ldy	#$00				; else
			lda	(dp_mos_OSBW_X),Y			; get value from address pointed to by &F0/1 (Y,X)
...
_CFS_CHECK_BUSY:	lda	dp_mos_cfs_critical			; read cassette critical flag bit 7 = busy
			bmi	_BE812				; if busy then EB12

			lda	#$08				; else A=8 to check current Catalogue status
			and	dp_mos_cfs_w			; by anding with CFS status flag
...
_OSWORD_7:		iny					
			lda	(dp_mos_OSBW_X),Y			; Get channel high byte byte
			cmp	#$ff				
...
_BE848:			jsr	_LE8C9				; Get Sync 0-3, and Cy if >=&10 for Hold
			...
			pha					; and stack it
			ldy	#$04				
			lda	(dp_mos_OSBW_X),Y			; Get pitch byte
			pha					; and stack it
			ldy	#$02				; 
			lda	(dp_mos_OSBW_X),Y			; Get amplitude/envelope byte
...
_OSBYTE_117:		ldx	dp_mos_vdu_status			; get VDU status byte in X
			rts					; and return
...
_VDU_7:			php					; push P
			sei					; bar interrupts
			lda	sysvar_BELL_CH			; get bell channel number in A
...
_SOUND_FF:		php					; Save flags
			iny					; Y=2
			lda	(dp_mos_OSBW_X),Y			; Get word number low byte
			pha					; and stack it
			iny					; Y=3
			lda	(dp_mos_OSBW_X),Y			; Get word number high byte
			pha					; and stack it
			ldy	#$00				; Y=0
			lda	(dp_mos_OSBW_X),Y			; Get speech command
...
_BE8BB:			cpy	#$0e				; is Y>=14??
			...
			lda	(dp_mos_OSBW_X),Y			; else get byte from parameter block
...
_LE8C9:			lda	(dp_mos_OSBW_X),Y			; get byte
...
_BE8D8:			ldy	#$04				; Y=4
_BE8DA:			lda	sysvar_BREAK_LAST_TYPE,X		; read byte
...
_BE8F2:			lda	(dp_mos_OSBW_X),Y			; and transfer all 5 bytes
			sta	sysvar_BREAK_LAST_TYPE,X		; to the clock or timer
			inx					; 
			dey					; 
...
_BE99A:			stx	dp_mos_OSBW_X				; store X
...
_BE9CF:			sta	SOFTKEYS,X			; and wipe clean
			...
			stx	sysvar_KEYB_SOFT_CONSISTANCY			; zero consistency flag
			rts					; and exit
...
_LEAD9:			lda	sysvar_BREAK_VECTOR_JMP			; get BREAK vector code
			eor	#$4c				; produces 0 if JMP not in &287
			bne	_BEAF3				; if not goto EAF3
			jmp	sysvar_BREAK_VECTOR_JMP			; else jump to user BREAK code
...
_OSBYTE_144:		lda	oswksp_VDU_VERTADJ			; VDU vertical adjustment
			stx	oswksp_VDU_VERTADJ			; store new value
			tax					; put old value in X
			tya					; put interlace flag in A
			and	#$01				; maximum value =1
			ldy	oswksp_VDU_INTERLACE			; get old value into Y
			sta	oswksp_VDU_INTERLACE			; put new value into A
_BEAF3:			rts					; and Exit
...
_LEB0A:			sta	SOUND_AMP_CUR,X			; store A to give basic sound level of Zero
			ldy	sysvar_SOUND_SUPPRESS			; get sound output/enable flag
...
_LEE18:			ldx	#$0d				; X=13
			inc	dp_mos_curPHROM			; 
			ldy	dp_mos_curPHROM			; get Rom
			bpl	__rfs_read_pagedrom		; if +ve it's a sideways ROM else it's a PHROM
			ldx	#$00				; PHROM
			stx	dp_mos_genPTR+1			; set address pointer in PHROM
			inx					; 
			stx	dp_mos_genPTR				; to 0001
...
_RFS_READ_ROM:		ldx	#$0e				; 
			ldy	dp_mos_curPHROM			; if Y is negative (PHROM)
...
_BEE82:			php					; push flags
			sei					; disable interrupts
_BEE84:			bit	sysvar_SPEECH_PRESENT			; test for prescence of speech processor
...
_LEEAD:			lda	CFS_RFS_LO			; set rom displacement pointer
			sta	dp_mos_genPTR				; in &F6
			lda	CFS_RFS_HI			; 
			sta	dp_mos_genPTR+1			; And &F7
			lda	dp_mos_curPHROM			; if F5 is +ve ROM is selected so
...
_LF137:			asl					; double it
			sta	sysvar_CFSRFS_SWITCH			; store it in filing system flag store
...
_LF140:			php					; save flags
			...
			sta	dp_mos_opt_val			; set load/save retry if error, short messages
...
_OSBYTE_143:		lda	dp_mos_curROM			; Get current ROM number
			pha					; Save it
...
_ARGSV:			ora	#$00				; is A=00
			...
			ora	sysvar_CFSRFS_SWITCH			; if cassette selected A=0 else A=2
			asl					; multiply by 2
			ora	sysvar_CFSRFS_SWITCH			; Or it again
			lsr					; divide by 2
...
_BF202:			bcc	_BF209				; if carry clear F209
			lda	#$03				; else A=3
			sta	sysvar_BREAK_EFFECT			; store to cause ESCAPE disable and memory
								; clear on break
...
_LF25A:			stx	dp_mos_txtptr			; OS filename/command line pointer lo
			sty	dp_mos_txtptr+1			; OS filename/command line pointer
			ldy	#$00				; Y=0
...
_FSCV_RUN:		jsr	_LF25A				; get filename from BUFFER
			...
			bit	sysvar_TUBE_PRESENT			; &FF if tube present
...
_LF33B:			lda	#$f7				; A=&F7
_LF33D:			and	dp_mos_cfs_w			; clear bit 3 of CFS status bit
_BF33F:			sta	dp_mos_cfs_w			; 
_BF341:			rts					; return

_LF342:			lda	#$40				; set bit 6 of E2 cassette options
_LF344:			ora	dp_mos_cfs_w			; 
			bne	_BF33F				; and Jump F33F

;********** search routine ***********************************************

_LF348:			pha					; save A on stack
			lda	sysvar_CFSRFS_SWITCH			; filing system flag 0=CFS 2=RFS
...
_BF370:			jsr	_LFB69				; inc. current block no.
			jsr	_LF77B				; read block header
_BF376:			lda	sysvar_CFSRFS_SWITCH			; get filing system flag 0=CFS 2=RFS
...
_BF39A:			pla					; get back A
			rts					; return
								;
_BF39C:			lda	sysvar_CFSRFS_SWITCH			; filing system flag 0=CFS 2=RFS
...
;************ close a file ***********************************************
			...
			jsr	_LF478				; tidy up
_BF3DD:			lsr	dp_mos_cfs_w			; CFS status byte is shifted left and right to zero
			asl	dp_mos_cfs_w			; bit 0
...
_BF416:			inx					; X=X+1
			...
			jsr	_LF342				; set CFS status bit 3 (EOF reached)
								; else
_BF42F:			lda	#$01				; A=1
			ora	sysvar_CFSRFS_SWITCH			; filing system flag 0=CFS 2=RFS
...
_LF478:			lda	#$02				; A=2 clearing all but bit 1 of status byte
			and	dp_mos_cfs_w			; CFS status byte, with output file open
...
_BGETV:			txa					; A=X
			...
			lda	dp_mos_cfs_w			; CFS status byte
...
_BF56A:			iny					; Y=Y+1
			and	dp_mos_opt_val			; clear lower two bits of each nybble
_BF56D:			ora	_LF581,Y			; or with table value
			sta	dp_mos_opt_val			; store it in &E3
			rts					; return
...
_LF637:			lda	CRFS_EXEC			; current block no. lo
			...
			jsr	_LFB81				; copy from 301/C+X to 3D2/C sought filename
_BF66D:			lda	sysvar_CFSRFS_SWITCH			; filing system flag 0=CFS 2=RFS
...
_OSCLI_EXEC:		php					; save flags on stack
			sty	dp_mos_OS_wksp				; &E6=Y
			ldy	sysvar_EXEC_FILE			; EXEC file handle
			sta	sysvar_EXEC_FILE			; EXEC file handle
			beq	_BF69B				; if not 0 close file via OSFIND
			jsr	OSFIND				; 
_BF69B:			ldy	dp_mos_OS_wksp				; else Y= original Y
			plp					; get back flags
...
_BF773:			jsr	_LFB78				; set (BE/C0) to 0
			...
			txa					; A=X
			bne	_BF7D4				; 
_LF77B:			lda	sysvar_CFSRFS_SWITCH			; filing system flag 0=CFS 2=RFS
...
;********* terminator found **********************************************
			...
			and	dp_mos_cfs_w			; CFS status byte
...
;****************  get character from file and do CRC  *******************
				;
_LF797:			lda	sysvar_CFSRFS_SWITCH			; filing system flag 0=CFS 2=RFS
...
_BF89A:			sta	sysvar_CFSTOCTR			; CFS timeout counter
_BF89D:			jsr	_CFS_READY			; confirm ESC not set and CFS not executing
			bit	sysvar_CFSTOCTR			; CFS timeout counter (decremented each 20ms)
...
_BF8E2:			lda	sysvar_CFSRFS_SWITCH			; filing system flag 0=CFS 2=RFS
...
_CFS_READY:		php					; save flags on stack
			bit	dp_mos_cfs_critical			; CFS Active flag
			bmi	_BF99E				; 
			bit	dp_mos_ESC_flag			; if ESCAPE condition
...
_BFA18:			dec	CRFS_BLOCK_FLAG			; current block flag
			...
			txa					; A=X
			and	sysvar_CFSRFS_SWITCH			; filing system flag 0=CFS 2=RFS
			bne	_BFA2C				; 
			txa					; A=X
			and	#$11				; 
			and	CRFS_OPTS			; current OPTions
...
_BFA2C:			pla					; get back A
			...
			lsr	dp_mos_cfs_critical			; halve CFS Active flag to clear bit 7
...
_LFAFC:			php					; save flags on stack
			...
			lda	#$00				; A=0
			sta	dp_mos_rs423timeout			; store A RS423 timeout counter
...
_BFB14:			plp					; get back flags
			bit	dp_mos_ESC_flag			; if bit 7of ESCAPE flag not set
...
_LFB1A:			lda	dp_mos_opt_val			; get cassette filing system options byte
...
_CFS_CLAIM_SERIAL:	lda	dp_mos_opt_val			; get cassette filing system options byte
								; high nybble used for LOAD & SAVE operations
								; low nybble used for sequential access
...
_BFB31:			cli					; allow interrupts
			php					; save flags on stack
			sei					; prevent interrupts
			bit	sysvar_RS423_USEFLAG			; check if RS423 is busy
			bpl	_BFB14				; if not FB14
			lda	dp_mos_rs423timeout			; see if RS423 has timed out
			bmi	_BFB14				; if not FB14

			lda	#$01				; else load RS423 timeout counter with
			sta	dp_mos_rs423timeout			; 1 to indicate that cassette has 6850
...
_LFB9C:			sta	CRFS_BLK_OFFSET			; file status or temporary store
			tya					; A=Y
			eor	sysvar_CFSRFS_SWITCH			; filing system flag 0=CFS 2=RFS
			tay					; Y=A
			lda	dp_mos_cfs_w			; CFS status byte
...
_LFBD3:			tax					; X=A
			...
			lda	sysvar_TUBE_PRESENT			; &FF if tube present
...
_EXTENDED:
	...
	; STACK  offset	descriptions
	;	+12..13	caller return - return address from original caller
	;	+10..11	"return" address to jsr in table above
	;	+5..9	-spare-
	;	+4	Flags
	;	+3	A
	;	+2	X
	...
	;	+10..11	"return" address to jsr in table above
	;	+9	-spare-
	;	+7..8	_EXTENDED_EXIT-1
	;	+5..6	Rom routine address
	;	+4	Flags
	;	+3	A
	;	+2	X
	;	+1	Y
			...
			sta	dp_mos_curROM			; store it as ram copy
...
;*************************************************************************	 ;
				;
_OSBYTE_150:		ldy	sheila_CRTC_reg,X			; read a byte from SHEILA memory mapped I/O area
			rts					; return
